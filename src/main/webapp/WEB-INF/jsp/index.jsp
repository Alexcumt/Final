...
<div class="header" id="home">
	<div class="container">
		<ul>
			...
			<li><i class="fa fa-phone" aria-hidden="true"></i> Call : 15722874552</li>
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">63783365@qq.com</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>G</span>mart <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
					...
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">User Sign in <span>Now!</span></h3>
						  ...
						  <ul class="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
														...
														<div class="clearfix"></div>
														<p><a href="#" data-toggle="modal" data-target="#myModal2" > Sign Up</a></p>
														<p><a href="#" data-toggle="modal" data-target="#myModal3" > Manager Sign In</a></p>
						</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-body modal-body-sub_agile">
						<div class="col-md-8 modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Manager Sign in <span>Come on!</span></h3>
									<form action="login" method="post">
							<div class="styled-input agile-styled-input-top">
								<input type="text" name="username" required="">
						  ...
						  <ul class="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
						                                ...
						                                <div class="clearfix"></div>
														<p><a href="#" data-toggle="modal" data-target="#myModal1" > User Sign In</a></p>
		...
		<div class="col-md-6 agileits_schedule_bottom_right">
			<div class="w3ls_schedule_bottom_right_grid">
				...
				<div class="col-md-4 w3l_schedule_bottom_right_grid1">
					...
					<h4>OlineCustomers</h4>
					<h5 class="counter">${listen.counter}</h5>
				</div>
				<div class="col-md-4 w3l_schedule_bottom_right_grid1">
						...
						<div class="tab1">
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="singleOne.html">Formal Blue Shirt</a></h4>
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="addToCart" method="post">
																<fieldset>
																	<!--<input type="hidden" name="cmd" value="_cart" /> -->
																	<input type="hidden" name="commodity_count" value="1" />
																	<input type="hidden" name="commodity_name" value="Formal Blue Shirt" />
																	<input type="hidden" name="commodity_price" value="30.99" />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="singleTwo.html">Gabi Full Sleeve Sweatshirt</a></h4>
										<div class="info-product-price">
											<span class="item_price">$45.99</span>
											<del>$69.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="addcart" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="commodity_count" value="1" />
																	<input type="hidden" name="commodity_count" value="Sweatshirt" />
																	<input type="hidden" name="commodity_count" value="30.99" />
																	<!-- <input type="hidden" name="cmd" value="_cart" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="USD" />
																	<input type="hidden" name="return" value=" " />
									...
									<div class="item-info-product ">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="addcart" method="post">
																<fieldset>
																    <input type="hidden" name="commodity_count" value="1" />
																	<input type="hidden" name="commodity_count" value="Dark Blue Track Pants" />
																	<input type="hidden" name="commodity_count" value="30.99" />
									...
									<div class="item-info-product ">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																    <input type="hidden" name="commodity_count" value="1" />
																	<input type="hidden" name="commodity_count" value="Black T-Shirt" />
																	<input type="hidden" name="commodity_count" value="30.99" />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Women's Black Jeans</a></h4>
										<div class="info-product-price">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="addcart" method="post">
																<fieldset>
																	<input type="hidden" name="commodity_count" value="1" />
																	<input type="hidden" name="commodity_count" value="Women's Black Jeans" />
																	<input type="hidden" name="commodity_count" value="30.99" />
																	<input type="submit" name="submit" value="Add to cart" class="button" />
																</fieldset>
															</form>
